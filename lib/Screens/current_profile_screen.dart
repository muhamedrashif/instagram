...
class CurretProfileScreen extends StatefulWidget {
   final uid;
   CurretProfileScreen({required this.uid});

  @override
  State<CurretProfileScreen> createState() => _CurrentProfileScreenState();
}

class _CurrentProfileScreenState extends State<CurretProfileScreen> {
  var userData = {};
  int postLen = 0;
  int followers = 0;
  int following = 0;
